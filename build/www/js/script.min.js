                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            (a = replaceAll(a, "ovEn", "roWen")),
                            (a = replaceAll(a, "oveN", "roweN")),
                            (a = replaceAll(a, ["nigger", "NiGgEr", "nIgGeR", "nIgger", "niGger", "nigGer", "niggEr", "niggeR"], "fine sir")),
                            (a = replaceAll(a, "Nigger", "Fine sir")),
                            (a = replaceAll(a, "NIGGER", "FINE SIR")),
                            (a = replaceAll(a, ["nigga", "Nigga", "NIGGA", "nIgGa", "NiGgA", "nIgga"], "person of colour"))
                            "undefined" != typeof b ? ((b = replaceAll(b, "{NAME}", this.userPublic.name)), (b = replaceAll(b, "{COLOR}", this.color)), (b = replaceAll(b, "oven", "RPS")), (b = replaceAll(b, "<", "&lt;"))) : (b = a.replace("&gt;", "")),
                            (a = linkify(a));
