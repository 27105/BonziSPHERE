                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            "undefined" != typeof b ? ((b = replaceAll(b, "{NAME}", this.userPublic.name)), (b = replaceAll(b, "{COLOR}", this.color)), (b = replaceAll(b, /(oven|OVEN|Oven|OvEn|oVeN|oVen|ovEn|oveN)/g, "Rowen.")), (b = replaceAll(b, "<", "&lt;")), (b = replaceAll(b, /(nigger|NiGgEr|nIgGeR|nIgger|niGger|nigGer|niggEr|niggeR|NIGGER|Nigger)/g, "fine sir")), (b = replaceAll(b, /(nigga|Nigga|NIGGA|nIgGa|NiGgA|nIgga)/g, "person of colour"))) : (b = a.replace("&gt;", "")),
                            (a = linkify(a));
