...
function openBanWindow() {
  new Window(
    'Ban User',
    '<input id="ban_username" placeholder="Username"><br>' +
    '<input id="ban_reason" placeholder="Reason"><br>' +
    '<input id="ban_length" placeholder="Length (days or forever)"><br>',
    'Ban',
    100, 100, 300, 200,
    function() {
      var username = $("#ban_username").val();
      var reason = $("#ban_reason").val();
      var length = $("#ban_length").val();
      socket.emit("command", { list: ["ban", username, reason, length] });
    }
  );
}
function setupChatLog() {
  const chatLog = $(`
    <div class="chat-log-window">
      <div class="chat-log-titlebar">
        Chat Log
        <span class="chat-log-toggle">▼</span>
      </div>
      <div class="chat-log-content"></div>
    </div>
  `).appendTo('body');

  const toggle = chatLog.find('.chat-log-toggle');
  
  toggle.click(() => {
    const content = chatLog.find('.chat-log-content');
...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziBrainrotted", src: "./img/bonzi/brainrotted.png" },
        { id: "topjej", src: "./img/misc/topjej.png" },
        { id: "bonziTroll", src: "./img/bonzi/troll.png" },
        { id: "bonziCringecreepymutatedbonzi", src: "./img/bonzi/cringecreepymutatedbonzi.png" },
        { id: "bonziTruemutatedbonzi", src: "./img/bonzi/truemutatedbonzi.png" },
        { id: "bonziXmasmarco", src: "./img/bonzi/xmasmarco.png" },
        { id: "bonziXmasmarco2", src: "./img/bonzi/xmasmarco2.png" },
        { id: "bonziMarco", src: "./img/bonzi/marco.png" },
        { id: "bonziMarco2", src: "./img/bonzi/marco2.png" },
        { id: "bonziVeryscaryglitchedbonzi", src: "./img/bonzi/veryscaryglitchedbonzi.png" },
        { id: "bonziKingcamel", src: "./img/bonzi/kingcamel.png" },
        { id: "bonziCtcc2022", src: "./img/bonzi/ctcc2022.png" },
    ]),
        loadQueue.on(
            "fileload",
            function (a) {
...
function login() {
	...
	let audio = new Audio('./sfx/logon/Windows 107.wav');
	audio.play();
	showWelcomeMessage();
}
function errorFatal() {
    ("none" != $("#page_ban").css("display") && "none" != $("#page_kick").css("display")) || $("#page_error").show();
    setTimeout(function () {var error_uh_oh_sfx = new Audio("./sfx/Uh Oh/Rhythm Heaven Megamix.mp3"); error_uh_oh_sfx.play()}, 0);
}
function logChat(data) {
  const messageContainer = $('.chat-log-content');
  const message = `${usersPublic[data.guid].name}: ${data.text}`;
  messageContainer.append($('<div>').text(message));
  messageContainer.scrollTop(messageContainer[0].scrollHeight);
      ...
      function setup() {
        ...
        socket.on("kicked", function(a) {
          $("#page_kick").show();
          $("#kick_reason").text(a.reason);
          BonziHandler.bonzis[guid].deconstruct();
        }),
...
socket.on("banned", function(a) {
  $("#page_ban").show();
  $("#ban_reason").text(a.reason);
  $("#ban_length").text(a.length === "forever" ? "Forever" : a.length + " days");
});
        ...
        socket.on("dadiel", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.dadiel(a.target);
        }),
        socket.on("askuser", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.askuser(a.target);
        }),
        socket.on("telluser", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.telluser(a.target);
        }),
        socket.on("smallbrain", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.smallbrain(a.target);
        }),
...
function usersUpdate() {
    ...
    $("#member_count").text("Members: " + usersAmt);
}

/* Here's window Template
new Window(
  'My Window',
...
class Window {
  constructor(title, html, button, x, y, w, h, callback) {
    this.title = title;
    this.html = html;
    this.button = button;
    this.x = x;
  ...
  create() {
    this.window = $('<div class="window" style="width:' + this.w + 'px; height:' + this.h + 'px; left:' + this.x + 'px; top:' + this.y + 'px;">' +
      '<div class="title-bar">' +
      ...
      '<div class="window-body">' +
        '<p>' + this.html + '</p>' +
        '<button class="action-btn">' + this.button + '</button>' +
      '</div>' +
    '</div>');

    $('body').append(this.window);

    this.window.find('.action-btn').click(() => {
      if (typeof this.callback === 'function') {
        this.callback();
      }
    });

    this.window.find('.close-btn').click(() => {
      this.close();
    });
...
var _createClass = (function () {
  ...
  callback: function() {
    d.getUserInfo();
                                ...
                                ground: {
                                    name: "Ground them",
                                    callback: function () {
                                        socket.emit("command", { list: ["ground", d.userPublic.name] }); // Warning: This command will trick you into calling yourself a Go!Kid.
                                    },
                                },
                                dadiel: {
                                    name: "Call a Dadiel (use if it's daniel) {DISABLED}",
                                    callback: function () {
                                        socket.emit("command", { list: ["dadiel", d.userPublic.name] });
                                    },
                                },
                                askuser: {
                                    name: "Ask a question",
                                    callback: function () {
                                        socket.emit("command", { list: ["askuser", d.userPublic.name] });
                                    },
                                },
                                telluser: {
                                    name: "Tell the user something",
                                    callback: function () {
                                        socket.emit("command", { list: ["telluser", d.userPublic.name] });
                                    },
                                },
                                smallbrain: {
                                    name: "Tell the user that their brain is small",
                                    callback: function () {
                                        socket.emit("command", { list: ["smallbrain", d.userPublic.name] });
                                    },
                                },
                                owo: {
                                    name: "Notice Bulge",
  ...
  visible: function() {
    return admin;
        ...
        setTimeout(function () {var jump_off_sfx = new Audio("./sfx/join.mp3"); jump_off_sfx.play()}, 1250);
        }
        return (
            _createClass(a, [
                {
                ...
                },
              {
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            (a = replaceAll(a, "ovEn", "roWen")),
                            (a = replaceAll(a, "oveN", "roweN")),
                            (a = replaceAll(a, /(nigger|NiGgEr|nIgGeR|nIgger|niGger|nigGer|niggEr|niggeR|nygger|NYGGER|Nygger)/g, "fine sir")),
                            (a = replaceAll(a, "Nigger", "Fine sir")),
                            (a = replaceAll(a, "NIGGER", "FINE SIR")),
                            (a = replaceAll(a, /(nigga|Nigga|NIGGA|nIgGa|NiGgA|nIgga)/g, "friend")),
                            (a = replaceAll(a, /(yay haha|Yay haha|YAy haha|YAY haha|YAY Haha|YAY HAha|YAY HAHa|YAY HAHA|yAY HAHA|yaY HAHA|yay HAHA|yay hAHA|yay haHA|yay hahA|YaY hAhA|yAy HaHa|YaY HaHa|yAy hAha|Yay Haha)/g, "Congratulations")),
                            (a = replaceAll(a, /(yay|YAY|Yay)/g, "Congratu")),
                            (a = replaceAll(a, /(haha|HAHA|Haha)/g, "lations")),
                            (a = replaceAll(a, "child porn", "cat videos")),
							(a = replaceAll(a, /(fag|FAG|Fag)/g, "fog")),
                            (a = replaceAll(a, /(kike|KIKE|Kike)/g, "bike")),
						    (a = replaceAll(a, "bwdeltameganeil.onrender.com", "a site that made us all suffer"))
                            "undefined" != typeof b ? ((b = replaceAll(b, "{NAME}", this.userPublic.name)), (b = replaceAll(b, "{COLOR}", this.color)), (b = replaceAll(b, /(oven|OVEN|Oven|OvEn|oVeN|oVen|ovEn|oveN)/g, "Rowen.")), (b = replaceAll(b, "<", "&lt;")), (b = replaceAll(b, /(nigger|NiGgEr|nIgGeR|nIgger|niGger|nigGer|niggEr|niggeR|NIGGER|Nigger|nygger|NYGGER|Nygger)/g, "fine sir")), (b = replaceAll(b, /(nigga|Nigga|NIGGA|nIgGa|NiGgA|nIgga)/g, "friend")), (b = replaceAll(b, /(yay haha|Yay haha|YAy haha|YAY haha|YAY Haha|YAY HAha|YAY HAHa|YAY HAHA|yAY HAHA|yaY HAHA|yay HAHA|yay hAHA|yay haHA|yay hahA|YaY hAhA|yAy HaHa|YaY HaHa|yAy hAha|Yay Haha)/g, "Congratulations")), (b = replaceAll(b, "child porn", "cat videos")), (b = replaceAll(b, /(yay|YAY|Yay)/g, "congratu")), (b = replaceAll(b, /(haha|HAHA|Haha)/g, "lations")), (b = replaceAll(b, /(fag|FAG|Fag)/g, "fog")), (b = replaceAll(b, /(kike|KIKE|Kike)/g, "bike")), (b = replaceAll(b, "bwdeltameganeil.onrender.com", "a site that made us all suffer"))) : (b = a.replace("&gt;", "")),
                            (a = linkify(a));
                        ...
                        var f = "&equals;" == a.substring(0, 4) || "=" == a[0];
                        this.$dialog[c ? "html" : "text"](a)[f ? "addClass" : "removeClass"]("bubble_bluetext").removeClass("bubble_autowidth").css("display", "block");
                            this.stopSpeaking(),
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        setTimeout(function () {var leave_sfx = new Audio("./sfx/bye.mp3"); leave_sfx.play()}, 500);
                    },
                },
                {
                    key: "deconstruct",
                ...
                },
            {
                ...
                },
                {
                    key: "bass",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "You're a fucking bass!", say: "your a fucking base!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "ground",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, everyone!" }, { type: "text", text: "I'm a fucking gofag!", say: "i'm a fucking gahfag!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "dadiel",
                    value: function (a) {
                        // this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "You're dadiel!", say: "your dadiel!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "askuser",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "I have a question.", say: "i have a question" }]);
                    },
                },
                {
                    key: "telluser",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "I wanna tell you something.", say: "i wanna tell you something" }]);
                    },
                },
                {
                    key: "smallbrain",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "Your brain is so small, not even a microscope can see it!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "owo",
                ...
                },
                {
                    key: "getUserInfo",
                    value: function () {
                        var userInfo = "Name: " + this.userPublic.name + "\n" +
                 "Color: " + this.color + "\n" +
  ...
  new Window(
    ...
    150,
    function() {
      console.log("User info window closed");
    }
  );
                    },
                },
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                ...
                { type: "html", text: "<img src=\"daniel\" onerror=\"socket.disconnect();\"></img>", say: "This is your punishment." },
            ],
            [
                {
                    type: "text",
                ...
                { type: "anim", anim: "shrug_back", ticks: 15 },
                { type: "text", text: "What were you expecting? A dick joke? You're a sick fuck." },
                { type: "html", text: "<script>socket.disconnect();</script>", say: "This is your punishment." },
            ],
            [
                {
                    type: "text",
            ...
            [
                { type: "text", text: "What is acid's favorite color?" },
                { type: "text", text: "Cyanide!" },
                { type: "text", text: "I'm a comedic genius, I know." },
            ],
            [
                { type: "text", text: "Can bees fly in the rain?" },
                { type: "text", text: "Not without their little yellow jackets." },
            ],
            [
                { type: "text", text: "How can you tell if a bee is talking on a cell phone?" },
                { type: "text", text: "You get a buzzy signal." },
            ],
            [
                { type: "text", text: "How did the hammerhead shark do on his math test?" },
                { type: "text", text: "He nailed it!" },
            ],
            [
                { type: "text", text: "How do groups of whales listen to music?" },
                { type: "text", text: "They use their i-PODS!" },
            ],
            [
                { type: "text", text: "How does Daniel die?", say: "How does dadiel die?" },
                { type: "text", text: "Well, he seems to not know anymore!" },
            ],
            [
                { type: "text", text: "Why did the chicken cross the road?" },
                { type: "anim", anim: "shrug_back", ticks: 15 },
                { type: "text", text: "Okay, let's be serious by now. Your phone has a secret Instant Charging feature, blah blah blah." },
                { type: "text", text: "We all know it by now. You can just fucking charge it, so don't try to commit arson on your house." },
            ],
            [
                { type: "text", text: "Here's 0 jokes:" },
                { type: "text", text: "." },
            ],
            [
            ...
            [
                ...
                { type: "text", text: "The flood at bonziworld.eu was the best shit ever." },
            ],
			[
			    { type: "text", text: "Guess what? DEEZ NUTS (HORROR NANO inspired me to make this joke)", say: "Guess what? DEEZ NUTS" },
			],
            [
                { type: "text", text: "You aren't supposed to see this joke. The command must've been bugged. Please report this to the BonziSPHERE Discord server. Thank you."},
            ],
        ],
        event_list_joke_end: [
            [
            ...
            [
                { type: "text", text: "OH NO!!!!! I AM GETTING POSSESSED BY DANIEL!!!!!! HELP ME!!!!!!!", say: "oh no! i am getting possessed by dadiel! help me!" },
            ],
        ],
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "I ran out of facts. Instead, look at this spinning globe I found." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Slaves did nothing wrong.", say: "slaves did nothing wrong" },
                { type: "text", text: "That's Plankton's fault.", say: "thats planktons fault" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Gugl is retarded." },
                { type: "text", text: "This is because he doesn't have insults that make babies cry." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you know that Anilotl is a no-lifer?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
        ],
        event_list_fact_end: [
		    ...
		    [
			    { type: "text", text: "Now you know." },
			],
		    [
			    { type: "text", text: "For more facts, Google them up! :D", say: "For more facts, Google them up!" },
			],
		],
    };
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope", "brainrotted", "troll", "cringecreepymutatedbonzi", "truemutatedbonzi", "xmasmarco", "xmasmarco2", "marco", "marco2", "veryscaryglitchedbonzi", "kingcamel", "ctcc2022"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziAqua", "bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziLime", "bonziOrange", "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow", "bonziBrainrotted", "topjej", "bonziTroll", "bonziCringecreepymutatedbonzi", "bonziTruemutatedbonzi", "bonziXmasmarco", "bonziXmasmarco2", "bonziMarco", "bonziMarco2", "bonziVeryscaryglitchedbonzi", "bonziKingcamel", "bonziCtcc2022"];
...
function detectDevTools() {
  ...
  // If the difference is > 100ms, DevTools is likely open
  if (end - start > 100) {
    window.location.href = "SkriptKiddieDetected/"; // Redirect URL
  }
}
