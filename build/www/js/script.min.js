...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziKingjew", src: "./img/bonzi/kingjew.png" },
...
function login() {
	...
	audio.play();
	showWelcomeMessage();
	// i had the fucking audacity to put a logon sound, cuz sticky was too lazy to add it mane
	// Googolcrowd
}
function errorFatal() {
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope", "brainrotted", "troll", "cringecreepymutatedbonzi", "truemutatedbonzi", "xmasmarco", "xmasmarco2", "marco", "marco2", "kingjew", "veryscaryglitchedbonzi", "kingcamel", "ctcc2022"], b = 0; b < a.length; b++) {
                        var c = a[b],
