                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            (a = replaceAll(a, "ovEn", "roWen")),
                            (a = replaceAll(a, "oveN", "roweN")),
                            (a = replaceAll(a, /(nigger|NiGgEr|nIgGeR|nIgger|niGger|nigGer|niggEr|niggeR)/g, "fine sir")),
                        ...
                        var f = "&lt;" == a.substring(0, 4) || "<" == a[0];
                        this.$dialog[c ? "html" : "text"](a)[f ? "addClass" : "removeClass"]("bubble_redtext").removeClass("bubble_autowidth").css("display", "block");
                        var g = "&equals;" == a.substring(0, 4) || "=" == a[0];
                        this.$dialog[c ? "html" : "text"](a)[g ? "addClass" : "removeClass"]("bubble_bluetext").removeClass("bubble_autowidth").css("display", "block");
                            this.stopSpeaking(),
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope", "brainrotted", "troll", "cringecreepymutatedbonzi", "truemutatedbonzi", "xmasmarco", "xmasmarco2", "marco", "marco2", "kingjew", "veryscaryglitchedbonzi", "kingcamel"], b = 0; b < a.length; b++) {
                        var c = a[b],
